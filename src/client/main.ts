...
This portfolio's interactive background uses Three.js with a physics worker driving instanced spheres and a customized physical shader. Layout + theming are pure Astro, TypeScript & CSS (glassmorphism, motion system, dark/light toggle).

Repo: (add your GitHub repo URL here) 

Questions? Reach out: @suganworks. Enjoy exploring! ✨`);
